...
$('.carousel-nav').prepend('<li class="carousel-nav__previous"><img src="img/arrow-prev.svg"></li>');
$('.carousel-nav').append('<li class="carousel-nav__next"><img src="img/arrow-next.svg"></li>');
